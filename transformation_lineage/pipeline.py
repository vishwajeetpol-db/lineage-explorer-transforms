...
Performance patch (PIPELINE_PERF_PATCH):
  - Phase 3 uses ThreadPoolExecutor (8 threads) for parallel artifact parsing
  - Phase 4 deduplicates nodes by node_id before writing
"""
...
def run_daily_pipeline(spark: SparkSession, cfg: LineageJobConfig) -> str:
    ...
    # ── Phase 4: Write parse metrics + graph records (with node dedup) ──
