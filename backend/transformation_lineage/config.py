...
class LineageJobConfig:
    ...
    # Git provider token for raw file fetch
    git_http_token: str | None = None

    # Entity types for system.access.column_lineage.
    ...
    def from_dbutils(
        ...
        **overrides: Any,
        ...
        """Resolve host/token from Spark conf and dbutils.secrets."""
